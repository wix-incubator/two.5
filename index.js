        ...
        _config.layers.forEach((layer, index) => {
            ...
            if (layer.scaleActive) {
                ...
                const scaleXVal = layer.scaleActive === 'sync'
                    ? scaleInitial + layer.scaleMaxX * (layer.scaleInvertX ? ease(layer.scaleEasing, 1 - Math.hypot((0.5 - x) * 2, (0.5 - y) * 2)) : ease(layer.scaleEasing, Math.hypot((0.5 - x) * 2, (0.5 - y) * 2))) * depth
                    : layer.scaleActive === 'y'
                        ? 1
                        : scaleInitial + layer.scaleMaxX * (layer.scaleInvertX ? ease(layer.scaleEasing, 1 - Math.abs(0.5 - scaleXInput) * 2) : ease(layer.scaleEasing, Math.abs(0.5 - scaleXInput) * 2)) * depth;
                const scaleYVal = layer.scaleActive === 'sync'
                    ? scaleInitial + layer.scaleMaxY * (layer.scaleInvertY ? ease(layer.scaleEasing, 1 - Math.hypot((0.5 - x) * 2, (0.5 - y) * 2)) : ease(layer.scaleEasing, Math.hypot((0.5 - x) * 2, (0.5 - y) * 2))) * depth
                    : layer.scaleActive === 'x'
                        ? 1
                        : scaleInitial + layer.scaleMaxY * (layer.scaleInvertY ? ease(layer.scaleEasing, 1 - Math.abs(0.5 - scaleYInput) * 2) : ease(layer.scaleEasing, Math.abs(0.5 - scaleYInput) * 2)) * depth;
...
function getHandler$1 ({target, progress, callback}) {
    let rect;
